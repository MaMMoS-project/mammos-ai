...
def test_classify_magnetic_from_Ms_A_K1_out_of_range_2d_array():
    ...
    K1 = me.Entity("MagnetocrystallineAnisotropyConstantK1", [[1e4, 1e6], [1e3, 1e8]])
...
def test_classify_magnetic_from_Ms_A_K1_accepts_compatible_magnetization_entities(Ms):
    """Test classification accepts spontaneous and saturation magnetization."""
    classification = mammos_ai.is_hard_magnet_from_Ms_A_K1(
        Ms,
...
@pytest.mark.parametrize(
    "K1",
    [
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e6, 2e6]),
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e6, 2e6]).q,
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e6, 2e6]).value,
    ],
)
...
@pytest.mark.parametrize(
    "K1",
    [
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [[1e5, 2e5], [3e5, 4e5]]),
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [[1e5, 2e5], [3e5, 4e5]]).q,
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [[1e5, 2e5], [3e5, 4e5]]).value,
    ],
)
...
def test_classify_magnetic_array_inputs():
    ...
    K1 = me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e4, 1e6])
...
def test_classify_magnetic_array_inputs_mixed_lengths():
    ...
    Ms = me.Entity("SpontaneousMagnetization", 1e6)
    A = me.Entity("ExchangeStiffnessConstant", [1e-12, 1e-12])
    K1 = me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e3, 1e8])
...
def test_Hc_Mr_BHmax_from_Ms_A_K1_accepts_compatible_magnetization_entities(Ms):
...
@pytest.mark.parametrize(
    "K1",
    [
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e5, 2e5]),
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e5, 2e5]).q,
        me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e5, 2e5]).value,
    ],
)
...
def test_Hc_Mr_BHmax_2d_array_inputs():
    ...
    K1 = me.Entity("MagnetocrystallineAnisotropyConstantK1", [[1e5, 2e5], [3e5, 4e5]])
    extrinsic_properties = mammos_ai.Hc_Mr_BHmax_from_Ms_A_K1(Ms, A, K1)
...
def test_Hc_Mr_BHmax_array_inputs_mixed_lengths():
    ...
    Ms = me.Entity("SpontaneousMagnetization", 1e6)
    A = me.Entity("ExchangeStiffnessConstant", [1e-12, 2e-12])
    K1 = me.Entity("MagnetocrystallineAnisotropyConstantK1", [1e6, 2e6])
